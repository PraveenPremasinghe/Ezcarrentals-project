      ...
      <section className="hero-section-bg" >
        <div className="container ">
          ...
          <div className="hero-text">
            <h1>Planning Your Next Journey With <img src={HeroTextImage}
              className="hero-text-img"
              alt="car-img"></img></h1>

            <h2>EZ Car Rentals</h2>
            <p>Compare prices from the best car rental companies in the world</p>
          </div>

          <div className="reserve-now">
            <button onClick={bookBtn} class="reserve-now-btn" ><span> RESERVE</span></button>
