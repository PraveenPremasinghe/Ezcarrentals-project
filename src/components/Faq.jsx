...
function Faq() {
          ...
          <div className="faq-content">
            ...
            <div className="all-questions">
              ...
              <div className="faq-box">
                ...
                >
                We charge this as a non-refundable payment which gets credited on to your final bill on pick up. This is charged as once a booking is confirmed we hold the car for you and may cancel other bookings to hold the car for you. 
                </div>
              </div>
              ...
              <div className="faq-box">
                ...
                >
                You can simply call us and we will take care of the rest. Our towing policy in case a vehicle needs towing covers 40km free of charge. Any additional km will be charged on to you. 
                </div>
              </div>
  ...
  >
    Sorry, we are a small rental business, so we don't allow interstate travel.
  </div>
</div>
...
<div className="faq-box">
  ...
  >
    Of course, you can. We pride ourselves on offering the best rates in our first go. If you wish to rent long-term, we can offer better rates.
  </div>
</div>
        ...
        <div className="container">
          <div className=" ">
            <div className="contact-div__text">
              ...
              <p>
              Feel free to call us. If we don't answer leave us a text and we will get back to you as soon as possible.
              </p>
              ...
              <div className="social-card ">
                <a href="https://www.instagram.com/ezcarvanrentals/" className="socialContainer containerOne">
                ...
                <a href="#" className="socialContainer containerFour" onClick={handleWhatsAppCall}>
